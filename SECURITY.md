...
1. **GitHub Private Vulnerability Reporting**
   ...
   [Security tab](https://github.com/IvanAnishchuk/y402/security/advisories/new).
...
uv tool run sigstore verify identity \
    --cert-identity 'https://github.com/IvanAnishchuk/y402/.github/workflows/release.yml@refs/tags/vX.Y.Z' \
    --cert-oidc-issuer 'https://token.actions.githubusercontent.com' \
    --bundle y402-*.whl.sigstore.json \
    y402-*.whl

# Verify GitHub attestation
gh attestation verify y402-*.whl --owner IvanAnishchuk
```
